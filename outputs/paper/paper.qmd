...
summary(anova_result)
```
Interestingly, there are virtually no differences in the average belief in free will between the different age groups surveyed (@fig-ageboxplotwvs in @sec-appendix). ANOVA confirmed that there are no significant differences (*F*(4,12809) = 1.032, *p* = 0.358). 
...
## Demographic Boxplots for World Values Survey
```{r}
#| echo: false
#| warning: false
#| message: false
